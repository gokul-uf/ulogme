...
{pattern : /gokul@/, mapto : 'Terminal'},
{pattern : /Terminal/, mapto : 'Terminal'},
{pattern : /Sublime Text/, mapto : 'SubText2'},
{pattern : /Eclipse/, mapto : 'Eclipse'},
{pattern : /RStudio/, mapto : 'RStudio'},
...
var display_groups = [];
display_groups.push(["Gmail", "Google Chrome", "MISC", "SubText2", "YouTube"]); // internet related
display_groups.push(["Matlab", "SubText2 Coding", "INotebook", "Terminal", "Papers", "Eclipse"]); // work related
...
// many magic numbers.
var hacking_titles = ["INotebook", "Terminal", "Matlab", "SubText2 Coding", "Eclipse"];
